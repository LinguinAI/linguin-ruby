...
class LinguinClientTest < Minitest::Test
  def stub_with_json(mock_response)
    ...
    stub_request(:get, "https://api.linguin.ai/v1/status")
      .to_return(
        status: 200,
        body: json_response,
  ...
  def test_that_status_raises_on_internal_errors
    ...
    stub_request(:get, "https://api.linguin.ai/v1/status").to_return(status: 500, body: error_message)
    client = Linguin::Client.new("abc")
  ...
  def test_that_status_raises_on_authentication_errors
    ...
    stub_request(:get, "https://api.linguin.ai/v1/status").to_return(status: 401, body: error_message)
    client = Linguin::Client.new("abc")
